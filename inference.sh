...
#
python inference.py --load_model "rwkv-6.pth" --wandb "rna-rwkv" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE \
 --ctx_len $CTX_LEN --my_pile_stage 3 --epoch_count 999999 --epoch_begin 0 \
 --test_json "/pvc/rna_dataset/rna_generate/rna_test.json"  --output_json "/pvc/RWKV/result/rnarwkv200k.json" --my_exit_tokens 114800000 --magic_prime 1793731 \
