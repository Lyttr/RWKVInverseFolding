...
python inference.py --load_model "rwkv-7.pth" --wandb "rna-rwkv" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE \
 ...
 --test_json "/home/gaji/rna_dataset/rna_test.json"  --output_json "/home/gaji/RWKV/result/ethbenchmark-topk0.01.json" --my_exit_tokens 114800000 --magic_prime 1793731 \
 ...
 --accelerator gpu --devices $GPU_PER_NODE --precision bf16 --strategy deepspeed_stage_2 --grad_cp $GRAD_CP --enable_progress_bar True --ds_bucket_mb $DS_BUCKET_MB --topk=4 --temperature 0.01