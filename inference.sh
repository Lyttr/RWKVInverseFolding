...
python inference.py --load_model "rwkv-7.pth" --wandb "rna-rwkv" --proj_dir $PROJ_DIR --my_testing $MODEL_TYPE \
 ...
 --test_json "/home/gaji/rna_dataset/rna_test.json"  --output_json "/home/gaji/RWKV/result/ethbenchmark-cmepoch8.json" --my_exit_tokens 114800000 --magic_prime 1793731 \
