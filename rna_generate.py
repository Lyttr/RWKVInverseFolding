...
def generate_one_valid(min_len, max_len, rnafold_cmd, test_structures):
...
def generate_train_set(test_structures, output_dir, train_size, chunk_size,
                       num_threads, min_len, max_len, rnafold_cmd, ctx_len):
            ...
            while len(train_data) < target_this_chunk and completed < train_size:
                ...
                with ThreadPoolExecutor(max_workers=num_threads) as executor:
                    futures = [
                        executor.submit(
                            generate_one_valid,
                            min_len, max_len, rnafold_cmd, test_structures
                        )
